...
Text Domain: ted-virtualsidebar 
*/
...
/*
UPDATES :
03/06/10 -> 1.2 : Adding domain for translating texts (POT)
                : Adding french translation (PO & MO)
...
$mmplugin_dir = basename(dirname(__FILE__));
load_plugin_textdomain( 'ted-virtualsidebar', 'wp-content/plugins/' . $mmplugin_dir, $mmplugin_dir );
